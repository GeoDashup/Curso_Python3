...
botonDiv=Button(miFrame, text="/", width=6, command=lambda:divide(numeroPantalla.get()))
...
botonMult=Button(miFrame, text="x", width=6, command=lambda:multiplica(numeroPantalla.get()))
...
botonRest=Button(miFrame, text="-", width=6, command=lambda:resta(numeroPantalla.get()))
